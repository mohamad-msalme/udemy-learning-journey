...
const local_api_1 = require("@eco-note/local-api");
...
exports.serveCommand = new commander_1.Command()
    ...
    try {
        ...
        const _fileName = path_1.default.basename(filename);
        yield (0, local_api_1.serve)(parseInt(options.port), _fileName, dir, !isProduction);
        console.log(`
